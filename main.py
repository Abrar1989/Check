...
import os
token = '7592733993:AAEsYFdLKos9klgdyaht5SjkNTnf-pwFleM' #bottoken
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '6590816421'
allowed_users = ['6590816421']  #Your ID
...
def add_user(message):
    if str(message.chat.id) == '6590816421':  # Only bot owner can add new users
        try:
...
def generate_code(message):
    if str(message.chat.id) == '6590816421':  # Only the bot owner can generate codes
